        ...
        <>
            ...
            <div className="container p-0" style={{ height: "297mm", width: "210mm" }} ref={documentRef} >
                ...
                <section className=' text-center p-5'>
                    ...
                    <div>
                        <p className="text-center">It is to certify to that,Mr.\Ms.
                            <abbr title="attribute" className='fw-bold'> Patel Aadhya Niketbhai </abbr> is/was enrolled
                            student of this college.He/She is studying <span className="h6"> MSCIT </span> in year  <span className="h6"> 2021-2022 </span>
                            in this college.Examination of  <span className="h6"> 2021-2022</span> held in  <span className="h6"> MSCIT sem-3 </span>was completed by them in first attempt.
                        </p>
                    </div>
                ...
                <div className="p-4 mb-3">
                    ...
                    <div className="p-4">
                        ...
                        <div>
                            ...
                            <p className="text-center"> As per our belief, he/she has a good characteristic.</p>
                        </div>
                    </div>
